...
configs_vary(
### Baseline
    { htm_binary_suffix: '.htm.fallbacklock', htm_conflict_resolution: "requester_wins",  htm_max_retries: 6, htm_allow_early_value_forwarding: False},
### Naive
    { htm_binary_suffix: '.htm.fallbacklock', htm_conflict_resolution: "requester_loses",  htm_max_retries: 2, htm_allow_early_value_forwarding: True, htm_fwd_mechanism: "naive", htm_max_consumed_blocks: 8, htm_n_val_fwd:16, htm_cycles_to_validate: 50},
### Powertm
       {
...
### LEVC
      {
        ...
        htm_max_retries: 64,
        htm_allow_early_value_forwarding: True,
        htm_fwd_mechanism: "W1_D1",
        htm_prio_mechanism: "no_prio",
        htm_allowed_data_fwd: "no_write_in_flight",
        htm_fwd_cycle_solve_strategy:"abort",
        htm_max_consumed_blocks: 4,
        htm_cycles_to_validate: 1
        },
